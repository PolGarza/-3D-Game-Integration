    ...
    <section class="Recomendaciones">
        ...
        <div class="contenedor">
            <div class="galeria_pub">
                ...
                <div class="imagen-port" data-url="PRIMER_NIVEL_M_1.php">
                    ...
                    <div class="hover-galeria">
                        ...
                        <a href="PRIMER_NIVEL_M_1.php">NORMAL</a>
                    </div>
                </div>

                <div class="imagen-port" data-url="NIVEL_ESPECIAL_M1.php">
                    <img src="STYLES/IMAGES/HALLOWEN.png" alt="" class="imagen-about-us">
                    <div class="hover-galeria">
                        <img src="STYLES/IMAGES/GATITO.png" alt="" class="imagen-about-us">
                        <a href="NIVEL_ESPECIAL_M1.php">HALLOWEN</a>
                    </div>
                </div>

                <div class="imagen-port" data-url="NIVEL_ESPECIAL_M2.ph">
                    <img src="STYLES/IMAGES/GROGU.png" alt="" class="imagen-about-us">
                    <div class="hover-galeria">
                        <img src="STYLES/IMAGES/GATITO.png" alt="" class="imagen-about-us">
                        <a href="NIVEL_ESPECIAL_M2.php">STAR WARS</a>
                    </div>
                </div>
