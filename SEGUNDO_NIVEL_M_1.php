...
<script type="module">
    ...
    let catModel, secondCatModel, carrotModel, chocolateModel;
    let cat1Counter = 0;
    let cat2Counter = 0;
...
function checkCollision() {
    ...
    if (window.cat1Counter === 5 || window.cat1Counter === -1) {
   ...
   // Verificar si cat1Counter alcanzó 1 punto
   if (window.cat2Counter === 5 || window.cat2Counter === -1) {
    // Mostrar la ventana modal
    const modal = document.getElementById('myModal');
    modal.style.display = "block";
